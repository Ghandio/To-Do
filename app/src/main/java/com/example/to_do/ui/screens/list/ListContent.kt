...
@Preview
fun PreviewTaskItem(){
    TaskItem(toDoTask = ToDoTask(0,"Ghandar",
        "wake up wake upwake upwake upwake upwake upwake upwake upwake upwake upwake upwake upwake upwake upwake up!",Priority.HIGH), navigateToTaskScreen ={} )
}