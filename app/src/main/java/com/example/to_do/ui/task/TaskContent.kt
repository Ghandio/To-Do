...
fun TaskContent(
    ...
    Column(modifier= Modifier
        ...
        OutlinedTextField(
            ...
            label = { Text(text = stringResource(id = R.string.task_content_title))},
        ...
        OutlinedTextField(
            ...
            label = {
                Text(text = stringResource(id = R.string.task_content_desc))
            },
            textStyle = MaterialTheme.typography.body1
...
fun PreviewTaskContent(){
    TaskContent("tezk 7amra",{  },"yes", {  },Priority.MEDIUM,{})
}